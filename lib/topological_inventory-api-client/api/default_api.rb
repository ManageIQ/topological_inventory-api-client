...
module TopologicalInventoryApiClient
  class DefaultApi
    ...
    # @option opts [Integer] :offset The number of items to skip before starting to collect the result set.
    # @option opts [Object] :filter Filter for querying collections.
    # @return [Array<(ServiceOfferingIconsCollection, Fixnum, Hash)>] ServiceOfferingIconsCollection data, response status code and response headers
    def list_service_offering_icons_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ServiceOfferingIconsCollection')
      if @api_client.config.debugging
    ...
    def show_service_offering_icon_icon_data_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id !~ Regexp.new(/^\d+$/)
        fail ArgumentError, "invalid value for 'id' when calling DefaultApi.show_service_offering_icon_icon_data, must conform to the pattern /^\d+$/."
      end
    ...
    def update_task_with_http_info(id, task, opts = {})
      ...
      if @api_client.config.client_side_validation && id !~ Regexp.new(/^\d+$/)
        fail ArgumentError, "invalid value for 'id' when calling DefaultApi.update_task, must conform to the pattern /^\d+$/."
      end
