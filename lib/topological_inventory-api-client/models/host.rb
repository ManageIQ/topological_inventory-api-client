...
module TopologicalInventoryApiClient
  class Host
    ...
    def list_invalid_properties
      ...
      if !@cluster_id.nil? && @cluster_id !~ Regexp.new(/^\d+$/)
        invalid_properties.push('invalid value for "cluster_id", must conform to the pattern /^\d+$/.')
      end
    ...
    def cluster_id=(cluster_id)
      if !cluster_id.nil? && cluster_id !~ Regexp.new(/^\d+$/)
        fail ArgumentError, 'invalid value for "cluster_id", must conform to the pattern /^\d+$/.'
      end
