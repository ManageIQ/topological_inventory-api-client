  ...
  class ContainerGroup
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TopologicalInventoryApiClient::ContainerGroup` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TopologicalInventoryApiClient::ContainerGroup`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'container_node_id')
        self.container_node_id = attributes[:'container_node_id']
      end

      if attributes.key?(:'container_project_id')
    ...
    def list_invalid_properties
      ...
      if !@container_node_id.nil? && @container_node_id !~ pattern
        invalid_properties.push("invalid value for \"container_node_id\", must conform to the pattern #{pattern}.")
      end

      pattern = Regexp.new(/^\d+$/)
      if !@container_project_id.nil? && @container_project_id !~ pattern
        invalid_properties.push("invalid value for \"container_project_id\", must conform to the pattern #{pattern}.")
      end
    ...
    def container_node_id=(container_node_id)
      pattern = Regexp.new(/^\d+$/)
      if !container_node_id.nil? && container_node_id !~ pattern
        fail ArgumentError, "invalid value for \"container_node_id\", must conform to the pattern #{pattern}."
      end
    ...
    def container_project_id=(container_project_id)
      pattern = Regexp.new(/^\d+$/)
      if !container_project_id.nil? && container_project_id !~ pattern
        fail ArgumentError, "invalid value for \"container_project_id\", must conform to the pattern #{pattern}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          container_node_id == o.container_node_id &&
