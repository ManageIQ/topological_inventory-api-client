...
module TopologicalInventoryApiClient
  class ServiceInstanceNode
    ...
    def hash
      [archived_at, created_at, extra, id, last_seen_at, name, root_service_instance_id, service_credential_id, service_instance_id, service_inventory_id, source_created_at, source_id, source_ref, source_updated_at, updated_at].hash
    end
