...
module TopologicalInventoryApiClient
  class NetworkAdapter
    ...
    def list_invalid_properties
      ...
      if !@device_id.nil? && @device_id !~ Regexp.new(/^\d+$/)
        invalid_properties.push('invalid value for "device_id", must conform to the pattern /^\d+$/.')
      end
    ...
    def device_id=(device_id)
      if !device_id.nil? && device_id !~ Regexp.new(/^\d+$/)
        fail ArgumentError, 'invalid value for "device_id", must conform to the pattern /^\d+$/.'
      end
