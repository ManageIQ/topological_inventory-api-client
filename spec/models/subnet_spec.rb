...
# Unit tests for TopologicalInventoryApiClient::Subnet
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Subnet' do
  before do
    # run before each test
    @instance = TopologicalInventoryApiClient::Subnet.new
  end
  ...
  describe 'test an instance of Subnet' do
    it 'should create an instance of Subnet' do
      expect(@instance).to be_instance_of(TopologicalInventoryApiClient::Subnet)
    end
  end
