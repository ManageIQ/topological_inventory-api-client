...
# Unit tests for TopologicalInventoryApiClient::NetworkAdapter
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'NetworkAdapter' do
  before do
    # run before each test
    @instance = TopologicalInventoryApiClient::NetworkAdapter.new
  end
  ...
  describe 'test an instance of NetworkAdapter' do
    it 'should create an instance of NetworkAdapter' do
      expect(@instance).to be_instance_of(TopologicalInventoryApiClient::NetworkAdapter)
    end
  end
