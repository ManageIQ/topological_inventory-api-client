...
# Unit tests for TopologicalInventoryApiClient::Host
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Host' do
  before do
    # run before each test
    @instance = TopologicalInventoryApiClient::Host.new
  end
  ...
  describe 'test an instance of Host' do
    it 'should create an instance of Host' do
      expect(@instance).to be_instance_of(TopologicalInventoryApiClient::Host)
    end
  end
