...
# Unit tests for TopologicalInventoryApiClient::ServiceInstance
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ServiceInstance' do
  before do
    # run before each test
    @instance = TopologicalInventoryApiClient::ServiceInstance.new
  end
  ...
  describe 'test an instance of ServiceInstance' do
    it 'should create an instance of ServiceInstance' do
      expect(@instance).to be_instance_of(TopologicalInventoryApiClient::ServiceInstance)
    end
  end
