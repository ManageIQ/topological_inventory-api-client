...
# Unit tests for TopologicalInventoryApiClient::Network
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Network' do
  before do
    # run before each test
    @instance = TopologicalInventoryApiClient::Network.new
  end
  ...
  describe 'test an instance of Network' do
    it 'should create an instance of Network' do
      expect(@instance).to be_instance_of(TopologicalInventoryApiClient::Network)
    end
  end
