...
# Unit tests for TopologicalInventoryApiClient::Subscription
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Subscription' do
  before do
    # run before each test
    @instance = TopologicalInventoryApiClient::Subscription.new
  end
  ...
  describe 'test an instance of Subscription' do
    it 'should create an instance of Subscription' do
      expect(@instance).to be_instance_of(TopologicalInventoryApiClient::Subscription)
    end
  end
