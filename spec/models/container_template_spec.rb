...
# Unit tests for TopologicalInventoryApiClient::ContainerTemplate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ContainerTemplate' do
  before do
    # run before each test
    @instance = TopologicalInventoryApiClient::ContainerTemplate.new
  end
  ...
  describe 'test an instance of ContainerTemplate' do
    it 'should create an instance of ContainerTemplate' do
      expect(@instance).to be_instance_of(TopologicalInventoryApiClient::ContainerTemplate)
    end
  end
