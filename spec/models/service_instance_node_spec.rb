...
# Unit tests for TopologicalInventoryApiClient::ServiceInstanceNode
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ServiceInstanceNode' do
  before do
    # run before each test
    @instance = TopologicalInventoryApiClient::ServiceInstanceNode.new
  end
  ...
  describe 'test an instance of ServiceInstanceNode' do
    it 'should create an instance of ServiceInstanceNode' do
      expect(@instance).to be_instance_of(TopologicalInventoryApiClient::ServiceInstanceNode)
    end
  end
